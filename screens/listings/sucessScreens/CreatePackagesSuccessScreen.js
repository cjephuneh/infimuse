...
const CreatePackagesSuccessScreen = ({ navigation }) => {
  ...
  return (
    <View style={tw`flex-1 justify-center items-center bg-white p-6`}>
      <Image 
        source={require('../../../assets/success2.jpeg')} 
        style={tw`mb-8 w-48 h-48`} 
        resizeMode="contain"
      />
      <Text style={tw`text-3xl font-bold text-gray-800 mb-6 text-center`}>Package Created Successfully!</Text>
      <TouchableOpacity 
...
export default CreatePackagesSuccessScreen;
