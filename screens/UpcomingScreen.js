...
import NoDataIcon from '../assets/image copy 2.png'; // Assuming you have an icon or GIF in assets
                ...
                <ScrollView contentContainerStyle={styles.scrollContainer}>
                    {listings.length > 0 ? (
                        ...
                        <View style={styles.noDataContainer}>
                            ...
                            <Text style={styles.noDataText}>No Upcoming Listings Found</Text>
