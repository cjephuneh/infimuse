      ...
      >
        <ScrollView style={tw`flex-grow`} contentContainerStyle={tw`justify-center`}>
          <View style={tw`w-full flex-1 justify-center items-center px-4 mt-14`}>
            <Icon name="key" size={60} color="#A72C76" style={tw`mb-10`} />
            <Text style={[tw`text-4xl font-bold mb-10 text-center`, { color: '#A72C76' }]}>OTP Verification</Text>
          ...
          <View style={tw`w-full pb-6 px-4`}>
            <TouchableOpacity onPress={() => navigation.goBack()}>
              <Text style={tw`text-md text-center`}>
                Back to <Text style={[tw`font-bold`, { color: '#A72C76' }]}>Sign In</Text>
              </Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
